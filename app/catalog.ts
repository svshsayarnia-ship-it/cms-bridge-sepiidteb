...
export const catalogGroups: CatalogGroup[] = [
  {
    ...
    description:
      "فیلر، مزوژل، اسکین‌بوستر و بوتاکس را در گروه‌های جدا ببینید.",
  ...
  },
  {
    ...
    description:
      "کوکتل‌های پوستی، دور چشم و مو را بر اساس نام و اطلاعات بسته ببینید.",
    categorySlugs: [
  ...
  },
  {
    ...
    description:
      "محصولات مصرف حرفه‌ای را با نام، قدرت و تعداد داخل بسته مقایسه کنید.",
...
export const catalogCategories: Category[] = [
  {
    ...
    description:
      "مدل‌ها را با نام کامل، حجم و تعداد داخل بسته کنار هم ببینید.",
    guide:
      "این صفحه برای شناخت بسته است؛ انتخاب مدل و روش استفاده با پزشک است.",
  ...
  },
  {
    ...
    groupTitle: "محصولات تزریقی زیبایی",
    description:
      "مدل‌های مزوژل و اسکین‌بوستر را بر اساس اطلاعات واقعی بسته ببینید.",
    guide:
      "مزوژل، اسکین‌بوستر و فیلر یکی نیستند؛ مشخصات هر مدل را جدا بخوانید.",
  ...
  },
  {
    ...
    groupTitle: "محصولات تزریقی زیبایی",
    description:
      "محصولات بوتولینوم را با نام دقیق، تعداد واحد و اطلاعات بسته ببینید.",
    guide:
      "شرایط نگهداری و اطلاعات بسته را قبل از تحویل با دقت بخوانید.",
  ...
  },
  {
    ...
    description:
      "کوکتل‌هایی با عنوان‌های رایج جوان‌سازی و کیفیت پوست را مقایسه کنید.",
    guide:
      "عنوان دسته به‌تنهایی نتیجه‌ای را تضمین نمی‌کند؛ مشخصات خود محصول را بخوانید.",
  ...
  },
  {
    ...
    groupTitle: "کوکتل‌های حرفه‌ای مزوتراپی",
    description:
      "محصولات این گروه را با نام مدل و ترکیبات نوشته‌شده روی بسته مقایسه کنید.",
    guide:
      "ترکیبات و روش استفاده هر مدل را از راهنمای همان محصول بخوانید.",
  ...
  },
  {
    ...
    groupTitle: "کوکتل‌های حرفه‌ای مزوتراپی",
    description:
      "محصولات مربوط به پوست اطراف چشم را با اطلاعات بسته و راه استعلام ببینید.",
    guide:
      "پوست اطراف چشم حساس است؛ انتخاب و استفاده را به فرد واجد صلاحیت بسپارید.",
  ...
  },
  {
    ...
    groupTitle: "کوکتل‌های حرفه‌ای مزوتراپی",
    description:
      "کوکتل‌های مو و پوست سر را ببینید و قبل از خرید علت ریزش را جدی بگیرید.",
    guide:
      "عنوان ضدریزش به‌تنهایی کافی نیست؛ علت ریزش باید اول بررسی شود.",
  ...
  },
  {
    ...
    description:
      "مدل‌ها را با قدرت و تعداد ویال یا آمپول داخل بسته مقایسه کنید.",
    guide:
      "این محصولات برای مصرف عمومی یا خانگی نیستند؛ اطلاعات همان بسته را بخوانید.",
