...
const productContentOverrides: Record<string, Partial<ProductSeed>> = {
  "mesoheal-plus": {
    summary:
      "مزوهیل پلاس در فهرست فعلی سپید بیوتی با عنوان مزوژل جوان‌ساز ثبت شده است. اطلاعات حجم، تعداد داخل بسته و مشخصات سازنده در منابع فعلی به‌صورت مستقل تأیید نشده؛ بنابراین نام مدل و بسته واقعی را پیش از سفارش کنترل کنید.",
    features: ["مدل: Mesoheal Plus", "گروه معرفی‌شده: مزوژل جوان‌ساز", "حجم و تعداد بسته از روی کالای موجود تأیید می‌شود"],
    specs: [["مدل", "Mesoheal Plus"], ["گروه", "مزوژل جوان‌ساز"], ["حجم و بسته", "نیازمند تطبیق با کالای موجود"], ["اطلاعات سازنده", "در منبع فعلی مستقل تأیید نشده"]],
    faq: [
      { question: "مزوهیل پلاس چه حجمی دارد؟", answer: "برای این مدل حجم ثابت و مستقل‌تأییدشده‌ای در فهرست فعلی ثبت نشده است؛ حجم روی بسته موجود معیار سفارش است." },
      { question: "قیمت مزوهیل پلاس برای کدام بسته است؟", answer: "واحد قیمت و تعداد داخل بسته باید هنگام استعلام با کالای موجود تطبیق داده شود." },
    ],
  },
  "xitritall-hydro": {
    volume: "۲ سی‌سی؛ گزارش بازار",
    summary:
      "زیتریتال هیدرو در فهرست فعلی با عنوان مزوژل آبرسان و حجم گزارش‌شده ۲ سی‌سی دیده می‌شود. املای لاتین، مشخصات سازنده و وضعیت بسته باید از روی محصول واقعی یا منبع رسمی بررسی شود؛ عنوان آبرسان به‌تنهایی نتیجه درمانی را تضمین نمی‌کند.",
    features: ["مدل: Xitritall Hydro", "حجم گزارش‌شده: ۲ سی‌سی", "نیازمند کنترل نام لاتین و بسته واقعی"],
    specs: [["مدل", "Xitritall Hydro"], ["گروه", "مزوژل آبرسان"], ["حجم گزارش‌شده", "۲ سی‌سی"], ["وضعیت اطلاعات", "گزارش بازار؛ نیازمند تطبیق بسته"]],
    faq: [
      { question: "زیتریتال هیدرو چند سی‌سی است؟", answer: "در فهرست فعلی حجم ۲ سی‌سی گزارش شده است؛ مقدار نهایی را روی بسته و برچسب همان محصول کنترل کنید." },
      { question: "آیا زیتریتال هیدرو برای همه پوست‌ها مناسب است؟", answer: "از نام آبرسان نمی‌توان تناسب محصول را برای همه افراد نتیجه گرفت؛ انتخاب محصول و روش باید توسط فرد واجد صلاحیت ارزیابی شود." },
    ],
  },
  "reyoungel-revital-bioha": {
    volume: "۲ سی‌سی؛ گزارش بازار",
    summary:
      "ری‌یانگل رویتال بایو اچ‌ای در فهرست فعلی به‌عنوان مزوژل جوان‌ساز با حجم گزارش‌شده ۲ سی‌سی ثبت شده است. نام کامل مدل و حجم بسته باید با محصول واقعی تطبیق داده شود؛ این صفحه برای مقایسه و استعلام است، نه تعیین پروتکل.",
    features: ["مدل: Revital BIOHA", "حجم گزارش‌شده: ۲ سی‌سی", "مشخصات بسته مبنای نهایی سفارش است"],
    specs: [["مدل", "Reyoungel Revital BIOHA"], ["گروه", "مزوژل جوان‌ساز"], ["حجم گزارش‌شده", "۲ سی‌سی"], ["منبع اطلاعات", "گزارش بازار؛ نیازمند تطبیق بسته"]],
    faq: [
      { question: "ری‌یانگل رویتال بایو اچ‌ای چند سی‌سی است؟", answer: "در فهرست فعلی حجم ۲ سی‌سی گزارش شده است؛ حجم درج‌شده روی بسته موجود را ملاک قرار دهید." },
      { question: "قیمت ری‌یانگل برای کدام بسته است؟", answer: "تعداد و واحد قیمت باید پیش از سفارش از روی بسته و استعلام موجودی مشخص شود." },
    ],
  },
  "vitten-hydro-plus": {
    volume: "۹ سی‌سی؛ بسته پنج‌عددی، گزارش بازار",
    summary:
      "ویتن هیدرو پلاس در فهرست فعلی با حجم گزارش‌شده ۹ سی‌سی و بسته پنج‌عددی دیده می‌شود. چون مشخصات بسته و وضعیت عرضه باید مستقل بررسی شود، تعداد، حجم و نام مدل را پیش از سفارش از روی کالای موجود کنترل کنید.",
    features: ["مدل: Vitten Hydro Plus", "حجم گزارش‌شده: ۹ سی‌سی", "بسته پنج‌عددی؛ نیازمند تطبیق کالای موجود"],
    specs: [["مدل", "Vitten Hydro Plus"], ["گروه", "مزوژل آبرسان"], ["حجم گزارش‌شده", "۹ سی‌سی"], ["بسته گزارش‌شده", "پنج‌عددی"]],
    faq: [
      { question: "ویتن هیدرو پلاس چند سی‌سی است؟", answer: "در فهرست فعلی ۹ سی‌سی گزارش شده است؛ حجم و تعداد نهایی باید روی بسته واقعی کنترل شود." },
      { question: "قیمت ویتن برای کدام بسته است؟", answer: "عبارت واحد قیمت باید هنگام استعلام روشن شود؛ بسته پنج‌عددی را با قیمت هر واحد اشتباه نگیرید." },
    ],
  },
  "roytrin-skin-booster": {
    summary:
      "رویترین اسکین‌بوستر در فهرست فعلی با همین نام ثبت شده است، اما حجم، مدل دقیق و وضعیت مجاز عرضه در منابع موجود به‌صورت قطعی تأیید نشده. صفحه برای مقایسه نام محصول و استعلام بسته واقعی است و نباید اطلاعات حدسی را جای مشخصات رسمی نشاند.",
    features: ["مدل: Roytrin Skin Booster", "حجم و تعداد بسته: نیازمند تأیید", "نام رسمی و وضعیت عرضه باید از منبع معتبر بررسی شود"],
    specs: [["مدل", "Roytrin Skin Booster"], ["گروه", "مزوژل و اسکین‌بوستر"], ["حجم", "ثبت قطعی نشده"], ["وضعیت اطلاعات", "نیازمند تطبیق منبع و بسته"]],
    faq: [
      { question: "رویترین اسکین‌بوستر چند سی‌سی است؟", answer: "حجم قطعی در فهرست فعلی ثبت نشده است؛ حجم روی بسته واقعی و منبع رسمی باید بررسی شود." },
      { question: "قیمت رویترین برای کدام بسته است؟", answer: "واحد قیمت و تعداد بسته هنگام استعلام مشخص می‌شود تا قیمت هر واحد با جعبه کامل اشتباه نشود." },
    ],
  },
  "dimono-3ml": {
    volume: "۳ سی‌سی؛ گزارش بازار",
    summary:
      "دیمونو ۳ سی‌سی در فهرست فعلی با عنوان مزوژل جوان‌ساز و حجم گزارش‌شده ۳ سی‌سی ثبت شده است. این مدل را با CG DIMONO PTx یا محصولات مزوتراپی دیمونو یکی نگیرید؛ نام کامل، تعداد سرنگ و بسته هر مدل جداگانه بررسی می‌شود.",
    features: ["مدل: Dimono 3 cc", "حجم گزارش‌شده: ۳ سی‌سی", "جدا از CG DIMONO PTx و Dimono Mesotherapy"],
    specs: [["مدل", "Dimono 3 cc"], ["گروه", "مزوژل جوان‌ساز"], ["حجم گزارش‌شده", "۳ سی‌سی"], ["نکته مقایسه", "مدل و بسته را با محصولات هم‌نام جابه‌جا نکنید"]],
    faq: [
      { question: "دیمونو ۳ سی‌سی با CG DIMONO PTx یکی است؟", answer: "خیر. این‌ها نام مدل‌های جدا هستند و محتویات و بسته هرکدام باید مستقل بررسی شود." },
      { question: "قیمت دیمونو ۳ سی‌سی برای کدام بسته است؟", answer: "واحد قیمت و تعداد داخل بسته هنگام استعلام موجودی مشخص می‌شود." },
    ],
  },
  "dimono-mesotherapy": {
    summary:
      "دیمونو مزوتراپی در فهرست فعلی با عنوان محصول مزوتراپی و جوان‌سازی ثبت شده است. حجم، تعداد و نام‌گذاری رسمی بسته برای این عنوان به‌صورت مستقل تأیید نشده؛ بنابراین نباید آن را با دیمونو ۳ سی‌سی یا CG DIMONO PTx جایگزین کرد.",
    features: ["مدل: Dimono Mesotherapy", "گروه معرفی‌شده: محصول مزوتراپی و جوان‌سازی", "حجم و بسته نیازمند تطبیق کالای موجود"],
    specs: [["مدل", "Dimono Mesotherapy"], ["گروه", "مزوتراپی و جوان‌سازی"], ["حجم و تعداد", "ثبت قطعی نشده"], ["نکته", "با مدل‌های Dimono دیگر اشتباه نشود"]],
    faq: [
      { question: "دیمونو مزوتراپی چه حجمی دارد؟", answer: "حجم قطعی این عنوان در فهرست فعلی ثبت نشده است؛ مشخصات بسته واقعی باید مبنای سفارش باشد." },
      { question: "دیمونو مزوتراپی با دیمونو ۳ سی‌سی یکی است؟", answer: "خیر. نام مدل و بسته باید جداگانه کنترل شود و عنوان برند به‌تنهایی برای جایگزینی کافی نیست." },
    ],
  },
  "luxiva": {
    summary:
      "لوکسیوا در فهرست‌های بازار با عنوان محصول حرفه‌ای پوست یا مزوژل دیده می‌شود، اما شکل بسته و واحد قیمت ممکن است بین عرضه‌ها متفاوت باشد. برای سفارش، نام مدل، حجم هر ویال یا سرنگ، تعداد بسته و قیمت به‌ازای واحد را از روی موجودی واقعی مشخص کنید.",
    features: ["مدل: LUXIVA", "گروه بازار: مزوژل یا محصول حرفه‌ای پوست", "حجم و واحد قیمت باید با بسته موجود تطبیق داده شود"],
    specs: [["مدل", "LUXIVA"], ["گروه", "مزوژل و محصول حرفه‌ای پوست"], ["حجم", "بسته به سری و عرضه؛ نیازمند تأیید"], ["واحد قیمت", "هر ویال، سرنگ یا جعبه باید روشن شود"]],
    faq: [
      { question: "لوکسیوا چند سی‌سی است؟", answer: "حجم را نمی‌توان فقط از نام لوکسیوا تعیین کرد؛ حجم هر واحد و تعداد بسته باید روی کالای موجود بررسی شود." },
      { question: "قیمت لوکسیوا برای کدام بسته است؟", answer: "پیش از سفارش مشخص کنید قیمت برای یک ویال، یک سرنگ یا جعبه کامل اعلام شده است." },
    ],
  },
  "dyston-500": {
    sourceName: "Dyston 500 — اطلاعات بازار",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل و بسته ۵۰۰ واحدی در فهرست فعلی ثبت شده؛ سازنده، مجوز و شرایط نگهداری باید از منبع رسمی همان بسته تأیید شود",
    summary: "دیستون ۵۰۰ در فهرست سپید بیوتی به‌عنوان یک فرآورده بوتولینوم ۵۰۰ واحدی ثبت شده است. اطلاعات سازنده، مجوز و شرایط نگهداری این مدل در منابع فعلی سایت به‌صورت مستقل تأیید نشده؛ بنابراین صفحه برای مقایسه نام مدل، مشخصات ثبت‌شده و استعلام بسته واقعی است و ادعای درمانی یا اصالت قطعی ارائه نمی‌کند.",
    features: ["مدل: Dyston 500", "بسته ثبت‌شده: ۵۰۰ واحد", "سازنده، مجوز و شرایط نگهداری باید از روی بسته و منبع رسمی تأیید شود"],
    specs: [["مدل", "Dyston 500"], ["گروه", "فرآورده بوتولینوم"], ["واحد ثبت‌شده", "۵۰۰ واحد"], ["وضعیت اطلاعات", "نیازمند تطبیق بسته و منبع رسمی"]],
    faq: [
      { question: "دیستون ۵۰۰ کدام بسته است؟", answer: "در فهرست فعلی، بسته ۵۰۰ واحدی برای این مدل ثبت شده است. مقدار و مشخصات نهایی را روی بسته و برچسب همان محصول کنترل کنید." },
      { question: "دیستون ۵۰۰ با مدل‌های دیگر چه تفاوتی دارد؟", answer: "نام و واحد محصول به‌تنهایی برای مقایسه کافی نیست؛ سازنده، بروشور، مجوز و شرایط نگهداری همان بسته باید جداگانه بررسی شود." },
    ],
  },
  "fusion-f-lift-face": {
    volume: "۵ ویال ۵ میلی‌لیتری",
    sourceName: "Fusion Meso — F-LIFT+FACE",
    sourceUrl: "https://fusionmeso.com/product/f-lift-face-sterile-serum-vials-for-wrinkles-and-skin-lifting/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل و اندازه بسته با صفحه رسمی Fusion Meso مرور شد",
    summary: "فیوژن اف لیفت پلاس فیس، ویال حرفه‌ای Fusion Meso برای برنامه‌های مراقبت از ظاهر خطوط و استحکام پوست است. صفحه رسمی برند بسته ۵ ویال ۵ میلی‌لیتری را معرفی می‌کند. نام دقیق F-LIFT+FACE و تعداد ویال، مبنای مقایسه با مدل‌های دیگر این برند است؛ انتخاب روش استفاده باید فقط توسط فرد واجد صلاحیت انجام شود.",
    features: ["بسته اعلام‌شده: ۵ ویال ۵ میلی‌لیتری", "مدل رسمی: F-LIFT+FACE", "محصول حرفه‌ای؛ انتخاب پروتکل با فرد واجد صلاحیت"],
    specs: [["نام رسمی", "F-LIFT+FACE"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["تعداد و حجم", "۵ ویال، هر ویال ۵ میلی‌لیتر"], ["گروه صفحه رسمی", "خطوط و استحکام ظاهری پوست"]],
    faq: [{ question: "بسته اف لیفت پلاس فیس چند ویال دارد؟", answer: "صفحه رسمی Fusion Meso این مدل را در بسته ۵ ویال ۵ میلی‌لیتری معرفی می‌کند. تعداد و حجم روی بسته تحویلی را پیش از سفارش بررسی کنید." }, { question: "اف لیفت پلاس فیس برای مصرف خانگی است؟", answer: "این صفحه، ویال حرفه‌ای را معرفی می‌کند. انتخاب روش استفاده و تناسب آن باید توسط فرد واجد صلاحیت انجام شود." }],
  },
  "fusion-f-mesomatrix": {
    volume: "۵ ویال ۵ میلی‌لیتری",
    sourceName: "Fusion Meso — F-MESOMATRIX",
    sourceUrl: "https://fusionmeso.com/product/f-mesomatrix-sterile-serum-vials-for-scars-and-stretch-marks/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل، حجم بسته و ترکیبات اعلام‌شده با صفحه رسمی Fusion Meso مرور شد",
    summary: "فیوژن اف مزوماتریکس، ویال حرفه‌ای Fusion Meso است که برند آن را در گروه جای زخم و استرچ‌مارک معرفی می‌کند. بسته رسمی اعلام‌شده شامل ۵ ویال ۵ میلی‌لیتری است و از اسید هیالورونیک، سیلیسیوم آلی، EGF و FGF و عصاره سنتلا نام برده می‌شود. این اطلاعات برای مقایسه مدل و بسته است و جایگزین ارزیابی پوست یا تصمیم درمانی نیست.",
    features: ["بسته اعلام‌شده: ۵ ویال ۵ میلی‌لیتری", "نام مدل: F-MESOMATRIX", "ترکیبات اعلام‌شده در صفحه برند: هیالورونیک اسید، سیلیسیوم آلی، EGF/FGF و سنتلا"],
    specs: [["نام رسمی", "F-MESOMATRIX"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["تعداد و حجم", "۵ ویال، هر ویال ۵ میلی‌لیتر"], ["ترکیبات اعلام‌شده", "اسید هیالورونیک، سیلیسیوم آلی، EGF و FGF، عصاره سنتلا"]],
    faq: [{ question: "بسته اف مزوماتریکس چه حجمی دارد؟", answer: "طبق صفحه رسمی Fusion Meso، بسته شامل ۵ ویال ۵ میلی‌لیتری است." }, { question: "اف مزوماتریکس برای چه هدفی معرفی می‌شود؟", answer: "برند آن را در گروه جای زخم و استرچ‌مارک معرفی می‌کند. تناسب هر روش با وضعیت پوست باید جداگانه توسط فرد متخصص ارزیابی شود." }],
  },
  "fusion-f-radiance": {
    volume: "۵ ویال ۱۰ میلی‌لیتری",
    sourceName: "Fusion Meso — F-RADIANCE",
    sourceUrl: "https://fusionmeso.com/product/f-radiance-sterile-serum-vials-for-pigmentation-and-melasma/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل، حجم بسته و فهرست ترکیبات اعلام‌شده با صفحه رسمی Fusion Meso مرور شد",
    summary: "فیوژن اف رادیانس، ویال حرفه‌ای Fusion Meso در گروه ناهمگونی رنگ و لک است. برند، بسته ۵ ویال ۱۰ میلی‌لیتری و ترکیباتی مانند ویتامین C، گلوتاتیون، رتینوئیدها، پپتیدها و فاکتور رشد TRX را اعلام می‌کند. محصول باید بر اساس علت تغییر رنگ پوست و نظر فرد واجد صلاحیت انتخاب شود؛ این صفحه وعده حذف قطعی لک نمی‌دهد.",
    features: ["بسته اعلام‌شده: ۵ ویال ۱۰ میلی‌لیتری", "مدل رسمی: F-RADIANCE", "حاوی ترکیبات اعلام‌شده از جمله ویتامین C و گلوتاتیون"],
    specs: [["نام رسمی", "F-RADIANCE"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["تعداد و حجم", "۵ ویال، هر ویال ۱۰ میلی‌لیتر"], ["ترکیبات اعلام‌شده", "ویتامین C، گلوتاتیون، رتینوئیدها، پپتیدها و TRX growth factor"]],
    faq: [{ question: "بسته اف رادیانس چند ویال دارد؟", answer: "صفحه رسمی Fusion Meso بسته ۵ ویال ۱۰ میلی‌لیتری را برای F-RADIANCE اعلام می‌کند." }, { question: "آیا اف رادیانس هر نوع لکی را برطرف می‌کند؟", answer: "خیر. لک و تغییر رنگ پوست علت‌های متفاوتی دارند و انتخاب محصول و روش باید پس از ارزیابی فرد متخصص انجام شود." }],
  },
  "fusion-f-vitamin-c": {
    volume: "۵ ویال ۱۰ میلی‌لیتری",
    sourceName: "Fusion Meso — F-VITAMIN C",
    sourceUrl: "https://fusionmeso.com/product/f-vitamin-c-micro-needling-serum-sterile-vial/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل و اندازه بسته با صفحه رسمی Fusion Meso مرور شد",
    summary: "فیوژن اف ویتامین سی، ویال حرفه‌ای Fusion Meso با ویتامین C است. صفحه رسمی برند آن را در بسته ۵ ویال ۱۰ میلی‌لیتری معرفی می‌کند و در گروه مراقبت از کدری و نشانه‌های ناشی از نور قرار می‌دهد. نام مدل، حجم و وضعیت پلمب را با بسته موجود تطبیق دهید؛ انتخاب کاربرد آن نیازمند نظر متخصص است.",
    features: ["بسته اعلام‌شده: ۵ ویال ۱۰ میلی‌لیتری", "مدل رسمی: F-VITAMIN C", "ترکیب شاخص اعلام‌شده: ویتامین C"],
    specs: [["نام رسمی", "F-VITAMIN C"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["تعداد و حجم", "۵ ویال، هر ویال ۱۰ میلی‌لیتر"], ["ترکیب اعلام‌شده", "ویتامین C"]],
    faq: [{ question: "حجم بسته اف ویتامین سی چقدر است؟", answer: "طبق صفحه رسمی Fusion Meso، F-VITAMIN C در بسته ۵ ویال ۱۰ میلی‌لیتری معرفی شده است." }, { question: "اف ویتامین سی همان فیلر است؟", answer: "خیر. این صفحه یک ویال حرفه‌ای Fusion Meso را معرفی می‌کند و نباید با فیلرهای حجم‌دهنده هم‌معنا در نظر گرفته شود." }],
  },
  "fusion-f-eye-contour": {
    sourceName: "Fusion Meso — F-EYE CONTOUR",
    sourceUrl: "https://fusionmeso.com/product-tag/eye-contour/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام مدل و گروه معرفی‌شده در صفحه رسمی Fusion Meso مرور شد؛ حجم بسته باید از روی کالای موجود کنترل شود",
    summary: "فیوژن اف آی کانتور، مدل حرفه‌ای Fusion Meso برای ناحیه ظریف اطراف چشم است. برند این مدل را در گروه eye contour معرفی می‌کند؛ بنابراین نباید آن را با کوکتل‌های عمومی پوست یا محصولات خانگی یکی دانست. حجم و تعداد ویالِ همان سری موجود، مبنای نهایی سفارش است.",
    features: ["مدل رسمی: F-EYE CONTOUR", "گروه معرفی‌شده: ناحیه اطراف چشم", "مشخصات بسته از روی کالای موجود کنترل می‌شود"],
    specs: [["نام رسمی", "F-EYE CONTOUR"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["گروه معرفی‌شده", "ناحیه اطراف چشم"]],
    faq: [{ question: "اف آی کانتور برای کدام ناحیه معرفی شده است؟", answer: "Fusion Meso این مدل را برای ناحیه اطراف چشم معرفی می‌کند." }, { question: "آیا حجم بسته اف آی کانتور ثابت است؟", answer: "حجم و تعداد ویال را از روی بسته موجود و اطلاعات فروشنده بررسی کنید تا مدل یا سری دیگری جایگزین نشود." }],
  },
  "fusion-f-hair": {
    sourceName: "Fusion Meso — F-HAIR",
    sourceUrl: "https://fusionmeso.com/product-tag/meso/",
    reviewedAt: "2026-08-22",
    sourceStatus: "نام خانواده محصول در سایت Fusion Meso مرور شد؛ نسخه و حجم باید از روی بسته موجود کنترل شود",
    summary: "فیوژن اف هیر نام یک مدل حرفه‌ای در خانواده محصولات موی Fusion Meso است. چون مدل‌ها و بسته‌بندی‌های این خانواده ممکن است متفاوت باشند، تنها نام F-HAIR برای تعیین حجم یا ترکیبات کافی نیست. هنگام سفارش، نسخه دقیق، تعداد ویال و حجم روی بسته را مشخص کنید و علت ریزش مو را پیش از انتخاب محصول با پزشک بررسی کنید.",
    features: ["مدل: F-HAIR", "خانواده حرفه‌ای مو و پوست سر", "نسخه و حجم از روی بسته موجود تعیین می‌شود"],
    specs: [["نام رسمی", "F-HAIR"], ["برند", "Fusion Meso"], ["شکل محصول", "محصول حرفه‌ای مو و پوست سر"], ["بسته", "نسخه دقیق روی کالای موجود کنترل می‌شود"]],
    faq: [{ question: "اف هیر برای چه کسانی انتخاب می‌شود؟", answer: "انتخاب محصول مو باید بعد از روشن‌شدن علت ریزش یا وضعیت پوست سر توسط فرد متخصص انجام شود؛ نام محصول به‌تنهایی تشخیص نیست." }, { question: "حجم اف هیر چقدر است؟", answer: "برای این صفحه، حجم ثابت و تأییدشده‌ای ثبت نشده است. مشخصات روی بسته موجود باید معیار سفارش باشد." }],
  },
  "fusion-f-melirutin": {
    volume: "۱۰ میلی‌لیتر",
    summary: "فیوژن اف ملی‌روتین، مدل حرفه‌ای Fusion Meso در گروه روشن‌کنندگی و یکنواختی رنگ پوست است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است؛ با این حال نام دقیق مدل و حجم روی بسته تحویلی باید مبنای سفارش باشد. این صفحه برای مقایسه محصول است و درباره نتیجه درمانی تضمین نمی‌دهد.",
    features: ["مدل: F-MELIRUTIN", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه صفحه: روشن‌کنندگی و یکنواختی رنگ"],
    specs: [["نام رسمی", "F-MELIRUTIN"], ["برند", "Fusion Meso"], ["شکل محصول", "ویال حرفه‌ای"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم اف ملی‌روتین چقدر است؟", answer: "در فهرست فعلی، حجم ۱۰ میلی‌لیتر درج شده است. پیش از سفارش، حجم را روی بسته موجود کنترل کنید." }, { question: "اف ملی‌روتین برای استفاده خانگی است؟", answer: "این محصول در بخش محصولات حرفه‌ای قرار گرفته است و انتخاب روش استفاده باید با فرد واجد صلاحیت باشد." }],
  },
  "mesolike-top-age-pro": {
    summary: "مزولایک تاپ ایج پرو در دسته کوکتل‌های حرفه‌ای جوان‌سازی و کیفیت پوست قرار دارد. برای انتخاب درست، نام کامل Top Age Pro را روی جعبه بررسی کنید؛ این نام با مدل‌های دیگر مزولایک یکی نیست. اگر حجم، ترکیبات یا نسخه بسته برای تصمیم شما مهم است، آن‌ها باید از روی محصول تحویلی تأیید شوند.",
    features: ["مدل: Top Age Pro", "دسته: جوان‌سازی و کیفیت پوست", "مشخصات فنی نهایی از روی بسته موجود"],
    specs: [["مدل", "Mesolike Top Age Pro"], ["شکل محصول", "کوکتل حرفه‌ای"], ["گروه", "جوان‌سازی و کیفیت پوست"]],
    faq: [{ question: "تاپ ایج پرو با مزولایک لیفت یکی است؟", answer: "خیر. این دو نام مدل جداگانه‌اند و نباید فقط بر اساس نام برند به‌جای هم سفارش داده شوند." }, { question: "حجم تاپ ایج پرو چقدر است؟", answer: "برای این صفحه حجم تأییدشده‌ای ثبت نشده است؛ مشخصات روی کالای موجود معیار سفارش است." }],
  },
  "mesolike-lift": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک لیفت، مدل حرفه‌ای Mesolike در گروه جوان‌سازی و کیفیت پوست است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. واژه Lift نام مدل است و نباید به‌تنهایی به معنی نتیجه تضمین‌شده یا مناسب‌بودن برای همه افراد خوانده شود؛ انتخاب محصول و روش با فرد واجد صلاحیت است.",
    features: ["مدل: Mesolike Lift", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه: جوان‌سازی و کیفیت پوست"],
    specs: [["مدل", "Mesolike Lift"], ["شکل محصول", "کوکتل حرفه‌ای"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک لیفت چقدر است؟", answer: "در فهرست فعلی ۱۰ میلی‌لیتر برای این مدل درج شده است. پیش از سفارش، حجم روی بسته موجود را کنترل کنید." }, { question: "آیا نام لیفت به معنی نتیجه قطعی است؟", answer: "خیر. نام محصول، تضمین نتیجه نیست و تناسب آن با هر فرد باید جداگانه ارزیابی شود." }],
  },
  "mesolike-whitening-shine": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک وایتنینگ شاین، مدل حرفه‌ای Mesolike در گروه روشن‌کنندگی و یکنواختی رنگ پوست است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. برای مقایسه، نام کامل Whitening Shine و حجم روی بسته را ملاک قرار دهید؛ علت لک یا تیرگی و انتخاب روش مناسب باید جداگانه ارزیابی شود.",
    features: ["مدل: Whitening Shine", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه: روشن‌کنندگی و یکنواختی رنگ"],
    specs: [["مدل", "Mesolike Whitening Shine"], ["شکل محصول", "کوکتل حرفه‌ای"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک وایتنینگ شاین چقدر است؟", answer: "در فهرست فعلی ۱۰ میلی‌لیتر برای این مدل درج شده است." }, { question: "آیا این محصول برای هر نوع لک مناسب است؟", answer: "خیر. تغییر رنگ پوست علت‌های متفاوت دارد و انتخاب محصول باید پس از ارزیابی فرد متخصص انجام شود." }],
  },
  "mesolike-glutathione": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک گلوتاتیون، مدل حرفه‌ای Mesolike در گروه روشن‌کنندگی و یکنواختی رنگ پوست است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. وجود واژه گلوتاتیون در نام، اطلاعات کامل ترکیبات یا نتیجه مصرف را نشان نمی‌دهد؛ فهرست ترکیبات و مشخصات بسته باید از روی محصول تحویلی بررسی شود.",
    features: ["مدل: Mesolike Glutathione", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه: روشن‌کنندگی و یکنواختی رنگ"],
    specs: [["مدل", "Mesolike Glutathione"], ["شکل محصول", "کوکتل حرفه‌ای"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک گلوتاتیون چقدر است؟", answer: "در فهرست فعلی، حجم ۱۰ میلی‌لیتر درج شده است." }, { question: "آیا نام گلوتاتیون، فهرست کامل ترکیبات را مشخص می‌کند؟", answer: "خیر. ترکیبات و غلظت‌ها باید از برچسب و بروشور همان بسته بررسی شوند." }],
  },
  "mesolike-eye-top": {
    volume: "۵ میلی‌لیتر",
    summary: "مزولایک آی تاپ، مدل حرفه‌ای Mesolike برای گروه اطراف چشم است. حجم درج‌شده در فهرست فعلی ۵ میلی‌لیتر است. از آن‌جا که پوست اطراف چشم حساس‌تر است، نام دقیق مدل، حجم و روش پیشنهادی نباید با کوکتل‌های عمومی پوست جایگزین شود؛ انتخاب روش با فرد واجد صلاحیت است.",
    features: ["مدل: Mesolike Eye Top", "حجم درج‌شده در فهرست: ۵ میلی‌لیتر", "گروه: اطراف چشم"],
    specs: [["مدل", "Mesolike Eye Top"], ["شکل محصول", "کوکتل حرفه‌ای"], ["حجم", "۵ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک آی تاپ چقدر است؟", answer: "در فهرست فعلی برای این مدل ۵ میلی‌لیتر درج شده است." }, { question: "آیا آی تاپ با کوکتل عمومی پوست یکی است؟", answer: "خیر. این مدل در گروه اطراف چشم قرار گرفته و نباید بدون ارزیابی متخصص با محصول عمومی جایگزین شود." }],
  },
  "mesolike-hair": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک هیر، مدل حرفه‌ای Mesolike در گروه مو و پوست سر است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. ریزش مو علت‌های متفاوتی دارد؛ بنابراین نام Hair به‌تنهایی تشخیص یا تضمین نتیجه نیست و انتخاب محصول باید پس از بررسی علت توسط فرد متخصص انجام شود.",
    features: ["مدل: Mesolike Hair", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه: مو و پوست سر"],
    specs: [["مدل", "Mesolike Hair"], ["شکل محصول", "کوکتل حرفه‌ای مو و پوست سر"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک هیر چقدر است؟", answer: "در فهرست فعلی ۱۰ میلی‌لیتر برای این مدل درج شده است." }, { question: "آیا مزولایک هیر برای هر ریزش مو مناسب است؟", answer: "خیر. ریزش مو علت‌های متفاوت دارد و ابتدا باید علت آن توسط فرد متخصص بررسی شود." }],
  },
  "mesolike-hair-men": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک هیر من، مدل حرفه‌ای Mesolike در گروه مو و پوست سر است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. عبارت Hair Men نام مدل بازار است و به‌تنهایی نوع ریزش، ترکیبات یا تناسب محصول را مشخص نمی‌کند؛ مشخصات بسته و نظر متخصص معیار تصمیم‌اند.",
    features: ["مدل: Mesolike Hair Men", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "گروه: مو و پوست سر"],
    specs: [["مدل", "Mesolike Hair Men"], ["شکل محصول", "کوکتل حرفه‌ای مو و پوست سر"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک هیر من چقدر است؟", answer: "در فهرست فعلی ۱۰ میلی‌لیتر برای این مدل درج شده است." }, { question: "آیا نام هیر من برای تشخیص نوع ریزش کافی است؟", answer: "خیر. علت ریزش و مناسب‌بودن محصول باید جداگانه توسط فرد متخصص ارزیابی شود." }],
  },
  "mesolike-dutasteride": {
    volume: "۱۰ میلی‌لیتر",
    summary: "مزولایک دوتاستراید، مدل حرفه‌ای Mesolike در گروه مو و پوست سر است. حجم درج‌شده در فهرست فعلی ۱۰ میلی‌لیتر است. به‌دلیل نام‌گذاری محصول، بررسی ترکیبات، منع مصرف، سابقه فرد و روش استفاده پیش از هر تصمیم ضروری است؛ این صفحه توصیه درمانی یا راهنمای دوز ارائه نمی‌کند.",
    features: ["مدل: Mesolike Dutasteride", "حجم درج‌شده در فهرست: ۱۰ میلی‌لیتر", "نیازمند ارزیابی حرفه‌ای پیش از انتخاب"],
    specs: [["مدل", "Mesolike Dutasteride"], ["شکل محصول", "کوکتل حرفه‌ای مو و پوست سر"], ["حجم", "۱۰ میلی‌لیتر؛ مشخصات روی بسته موجود مبناست"]],
    faq: [{ question: "حجم مزولایک دوتاستراید چقدر است؟", answer: "در فهرست فعلی ۱۰ میلی‌لیتر برای این مدل درج شده است." }, { question: "آیا می‌توان مزولایک دوتاستراید را بدون ارزیابی استفاده کرد؟", answer: "خیر. ترکیبات، منع مصرف و تناسب آن باید پیش از انتخاب توسط فرد واجد صلاحیت بررسی شود." }],
  },
};
