...
const seeds: ProductSeed[] = [
  ...
  },
  {
    ...
    nameEn: "MASPORT® 500",
    brand: "Masport / مصون دارو",
    category: "botulinum-toxins",
    type: "سم بوتولینوم نوع A خالص‌شده و لیوفیلیزه",
    volume: "۱ ویال ۵۰۰ واحدی ۳ میلی‌لیتری همراه حلال",
    badge: "پر‌جست‌وجو در ایران",
    publishedInCatalog: true,
    sourceName: "Masoon Darou — MASPORT® 500",
    sourceUrl: "https://masoondarou.com/en/uncategorized/botulinum-toxin-type-a-btna-masport/",
    reviewedAt: "2026-08-10",
    sourceStatus: "واحد، شکل فرآورده و بسته‌بندی با صفحه رسمی مصون دارو تطبیق شد",
    summary:
      "مصپورت ۵۰۰ فرآورده ایرانی سم بوتولینوم نوع A از شرکت مصون دارو است. سازنده آن را به‌صورت ویال ۵۰۰ واحدی پودر لیوفیلیزه همراه حلال معرفی می‌کند. عدد واحد یا شباهت نام، مجوز جایگزینی با برند دیگر نیست و مصرف باید کاملاً حرفه‌ای باشد.",
    ...
    features: [
      ...
      "تولید شرکت ایرانی مصون دارو",
    ],
    specs: [
      ["نام رسمی", "MASPORT® 500"],
      ["سازنده", "شرکت داروسازی مصون دارو"],
    ...
    checks: [
      "عبارت MASPORT® 500، نام مصون دارو، بچ‌کد و تاریخ روی ویال و جعبه تطبیق داده شود.",
    ...
    faq: [
      {
        ...
        answer:
          "طبق صفحه رسمی سازنده، MASPORT® 500 محصول شرکت داروسازی مصون دارو در ایران است.",
      },
      {
