...
export const DEFAULT_SITE_PRESENTATION: SitePresentation = {
  ...
  home: { hero: {
    eyebrow: "انتخاب آگاهانه برای محصولات حرفه‌ای زیبایی",
    title: "محصول مناسب را با اطلاعات روشن انتخاب کنید.",
    description: "قبل از رفتن سراغ فهرست محصولات، مسیر خریدتان را مشخص کنید؛ سپس مدل، حجم، نوع بسته، قیمت و موجودی را برای همان محصول کنار هم بررسی کنید.",
    primaryCtaLabel: "راهنمای انتخاب محصول", primaryCtaHref: "/#find-product",
    secondaryCtaLabel: "خرید برای کلینیک", secondaryCtaHref: "/professional",
    microproofItems: ["مدل و بسته شفاف", "استعلام پیش از سفارش", "پشتیبانی دفتر و واتساپ"],
    image: "/images/drive/hero-rejuvenation.webp",
    imageAlt: "تصویر ادیتوریال سپید بیوتی برای محصولات حرفه‌ای زیبایی",
    editorialLabel: "سپید بیوتی", editorialCaption: "از انتخاب تا استعلام، با مسیر روشن",
    qualityTitle: "پیش از سفارش روشن کنید", qualitySubtitle: "مدل · بسته · قیمت · موجودی",
  } },
...
const EDITORIAL_IDENTITY_COPY = {
  ...
  home: {
    hero: {
      ...
      editorialLabel: DEFAULT_SITE_PRESENTATION.home.hero.editorialLabel,
