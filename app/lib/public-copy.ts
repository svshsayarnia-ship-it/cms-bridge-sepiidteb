...
export function toPublicCopy(value: string): string {
  return value
    ...
    .replace(/صفحه فعلی سپید بیوتی/gu, "سپید بیوتی")
    ...
    .replace(/ثبت[‌ ]شده است/gu, "موجود است")
    .replace(/موجود در کاتالوگ/gu, "موجود")
    ...
    .replace(/استعلام قیمت و موجودی/gu, "دیدن قیمت و موجودی")
    .replace(/استعلام قیمت/gu, "قیمت و موجودی")
    ...
    .replace(/در سپید بیوتی قابل انتخاب است/gu, "یکی از مدل‌های موجود است")
    ...
    .replace(/در سپید بیوتی عرضه می‌شود و در سپید بیوتی موجود است/gu, "در سپید بیوتی موجود است")
    .replace(/\s+([.!؟؛،])/g, "$1")
    .replace(/\s{2,}/g, " ")
    .trim();
}
