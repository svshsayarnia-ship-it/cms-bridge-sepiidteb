...
export function SiteFooter({ presentation }: { presentation: SitePresentation["footer"] & { brandTagline: string } }) {
  return <footer className="sb-footer"><div className="sb-shell">
    ...
    <div className="sb-footer__grid">
      <div className="sb-footer__brand"><BrandMark light tagline={presentation.brandTagline} /><p>{presentation.brandDescription}</p><div className="sb-footer__socials"><Link href="https://wa.me/989037251266">واتساپ</Link><Link href="tg://resolve?phone=989037251266">تلگرام</Link></div></div>
