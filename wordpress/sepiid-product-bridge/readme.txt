...
* یکپارچه‌سازی جست‌وجوی ورود OTP با جدول هویتی شماره موبایل ساخته‌شده در ثبت‌نام.
* ذخیره مستقیم نمایه استاندارد شماره در لحظه ساخت و ویرایش حساب مشتری.

= 1.8.12 =

* شناسایی حساب‌های قدیمی از متادیتای رایج افزونه‌های ورود موبایلی، از جمله `digits_phone` و `digits_phone_no`.
* محدودکردن جست‌وجوی شماره به کلیدهای شناخته‌شده و حفظ تشخیص تعارض بین حساب‌ها.

= 1.8.11 =

* بازیابی ورود پیامکی حساب‌های قدیمی که شماره موبایل آن‌ها به‌عنوان نام کاربری وردپرس ذخیره شده است.
* ثبت شماره استاندارد در اطلاعات صورتحساب و نمایه جست‌وجوی موبایل پس از تأیید موفق OTP.
* حفظ قرارداد تأییدشده رازبان/IPPanel بدون تغییر توکن، پترن یا خط ارسال.
